...
def main():
    ...
    # Step-0 api
    # Xzyao-BLAH9
    api_key = 'sk-kNElWISrL5fnQvdbNmp8nP4mbUBgn1p5Hs0Tf2YI5YfzqEr8'
    ...
    # sent_path = '/Users/yao/Nutstore Files/Mac2PC/LLM-EPOP-RE_BLAH9_2025-01-15/zero-shot-evaluation-main/experiments/documents'
    # prompt_dir = '/Users/yao/Nutstore Files/Mac2PC/LLM-EPOP-RE_BLAH9_2025-01-15/zero-shot-evaluation-main/experiments/instructions'
    # save_path = '/Users/yao/Nutstore Files/Mac2PC/LLM-EPOP-RE_BLAH9_2025-01-15/zero-shot-evaluation-main/experiments/output/repetition/kimi'

    # Texte2.txt, Texte5.txt, Texte10.txt
    # sent_file = f'{sent_path}/Texte10.txt'
    # # short.txt, ner+rel.txt, scenario.txt
    # prompt_file = f'{prompt_dir}/short.txt'
